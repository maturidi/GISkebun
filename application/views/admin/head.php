    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="dropdown dropdown-user">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          ...
          <li><a data-toggle="modal" data-target="#edit" ><i class="glyphicon glyphicon-user"></i> Ubah Data</a></li>
          <li><a data-toggle="modal" data-target="#update"><i class="icon-cog5"></i> Ubah Username Dan Password</a></li>
          <li><a data-toggle="modal" data-target="#foto"><i class="glyphicon glyphicon-camera"></i> Ubah Foto</a></li>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="form-group sr-only">
              ...
              <div class='col-md-9'><input type="text" name="id" readonly value="<?=$this->session->userdata('kd_admin');?>" class="form-control" ></div>
            </div>
            <br>
            <div class="form-group">
              <label class='col-md-3'>Nama</label>
              <div class='col-md-9'><input type="text" name="nama" autocomplete="off" value="<?php echo getnama($this->session->userdata('kd_admin')); ?>" class="form-control" ></div>
            </div>
            <br>
            <div class="form-group">
              <label class='col-md-3'>Email</label>
              <div class='col-md-9'><input type="text" name="email" autocomplete="off" value="<?php echo getemail($this->session->userdata('kd_admin')); ?>" class="form-control" ></div>
            </div>
            <br>
            <div class="form-group">
              <label class='col-md-3'>Telepon</label>
              <div class='col-md-9'><input type="text" name="telepon" autocomplete="off" value="<?php echo gettelepon($this->session->userdata('kd_admin')); ?>" class="form-control" ></div>
            </div>
            <br><br>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class='col-md-9'><input type="text" name="username" autocomplete="off" value="<?php echo getusername($this->session->userdata('kd_admin')); ?>" class="form-control" ></div>
            </div>
            <br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <div class='col-md-9'>
                <img src="<?php echo base_url('uploads/'.getfoto($this->session->userdata('kd_admin'))); ?>" alt="" height="70px">
